    ...
    <div class="case-num">
        <div class="container">
            <div class="title">
                <span
                    >截至
                    {{ formatData(caseInfo.modifyTime) }} 全国数据统计</span
                >
            </div>
        </div>
        <div class="num">
                        ...
                        <div class="create-count">
                            <b>
                                ...
                                <em style="color: rgb(247, 76, 49)">{{
                                    formatNum(caseInfo.currentConfirmedIncr)
                                }}</em>
                            </b>
                        </div>
                        <strong style="color: rgb(247, 76, 49)">{{
                            caseInfo.currentConfirmedCount
                        }}</strong>
                        <span>现存确诊</span>
                    </div>
                </li>
                        ...
                        <div class="create-count">
                            <b>
                                ...
                                <em style="color: rgb(247, 130, 7)">{{
                                    formatNum(caseInfo.seriousIncr)
                                }}</em>
                            </b>
                        </div>
                        <strong style="color: rgb(247, 130, 7)">{{
                            caseInfo.seriousCount
                        }}</strong>
                        <span>现存无症状</span>
                    </div>
                </li>
                        ...
                        <div class="create-count">
                            <b>
                                ...
                                <em style="color: rgb(162, 90, 78)">{{
                                    formatNum(caseInfo.suspectedIncr)
                                }}</em>
                            </b>
                        </div>
                        <strong style="color: rgb(162, 90, 78)">{{
                            caseInfo.suspectedCount
                        }}</strong>
                        <span>境外输入</span>
                    </div>
                </li>
                        ...
                        <div class="create-count">
                            <b>
                                ...
                                <em style="color: rgb(174, 33, 44)">{{
                                    formatNum(caseInfo.confirmedIncr)
                                }}</em>
                            </b>
                        </div>
                        <strong style="color: rgb(174, 33, 44)">{{
                            caseInfo.confirmedCount
                        }}</strong>
                        <span>累计确诊</span>
                    </div>
                </li>
